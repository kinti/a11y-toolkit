...
assert init['serverInfo']['name'] == 'a11y-toolkit' and init['serverInfo']['version'] == '3.6.0'
assert 'WCAG' in init['instructions'] and 'prompts' in init['capabilities']

nombres = [t['name'] for t in por_id[2]['result']['tools']]
assert len(nombres) == 14 and 'a11y_autofix' in nombres and 'a11y_reflow' in nombres, nombres
...
print('TESTS MCP PASAN ✓ (handshake+instructions, 14 tools EN, 5 prompts, criterion 2.5.8, audit html inline, hsl/nombres)')
