...
assert init['serverInfo']['name'] == 'a11y-toolkit' and init['serverInfo']['version'] == '3.15.0'
assert 'WCAG' in init['instructions'] and 'prompts' in init['capabilities']

nombres = [t['name'] for t in por_id[2]['result']['tools']]
assert len(nombres) == 18 and 'a11y_forms' in nombres and 'a11y_evidence' in nombres, nombres
...
print('TESTS MCP PASAN ✓ (handshake+instructions, 18 tools EN, 5 prompts, criterion 2.5.8, audit html inline, hsl/nombres)')
