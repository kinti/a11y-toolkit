...
assert init['serverInfo']['name'] == 'a11y-toolkit' and init['serverInfo']['version'] == '3.17.0'
assert 'WCAG' in init['instructions'] and 'prompts' in init['capabilities']

nombres = [t['name'] for t in por_id[2]['result']['tools']]
assert len(nombres) == 19 and 'a11y_html_validate' in nombres and 'a11y_forms' in nombres, nombres
